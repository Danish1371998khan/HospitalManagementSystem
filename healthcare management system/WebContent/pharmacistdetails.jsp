...
<div id="main_container">
	...
	<h2 align="center" style="font-family:verdana;font-size:14px;">New Doctor Details</h2>
	<table align="center" width="900" style="border:21px solid orange;">
	<tr class="button3">
	
	<th width="160" height="31" align="left"><font color="#990000">Pharmacist Id</font></th>
	  <th width="140" align="left"><font color="#990000">Pharmacist Name</font></th>
	  ...
	  <th width="70" align="left"> <font color="#990000">Mobile No</font></th>
	   <th width="86" align="left"> <font color="#990000">City</font></th>
	    <th width="72" class="paragraping"> <font color="#990000">Address</font></th>
...
ResultSet rs = null;
String phaid = null,phaname = null,phaqua = null,phades=null,phaemail = null,phamobile = null,phacity = null,phaaddress=null;
try {
con=databasecon.getconnection();
stmt = con.prepareStatement("select * from pharmacist");
	     
	   rs = stmt.executeQuery();
while (rs.next())  {

	      phaid=rs.getString("phaid");
		   phaname=rs.getString("phaname");
		   
		  
		   phaqua=rs.getString("phaqua");
		   phades=rs.getString("phades");
		   phaemail=rs.getString("phaemail");
		   phamobile=rs.getString("phamobile");
		   phacity=rs.getString("phacity");
		   phaaddress=rs.getString("phaaddress");
		  %>
		  <tr>
