...
PreparedStatement ps=null;
	...
	String c = request.getParameter("euname");
...
ps=con.prepareStatement("INSERT INTO employee(eid,ename,euname,pwd,qua,des,email,mobile,city,dob,sal,address,gender)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)");
