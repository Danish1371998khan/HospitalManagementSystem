...
<div id="main_container">
	...
	<h2 align="center" style="font-family:verdana;font-size:14px;">Patient Discharge Details</h2>
	...
	<th width="55" height="31" align="left"><font color="#990000">Patient Id</font></th>
	  ...
	  <th width="76" align="left"> <font color="#990000">Room Type</font></th>
	   ...
	   <th align="left"><font color="#990000">Discharge Date</font></th>
...
ResultSet rs = null;
String pid = null,pname = null,wardno=null,wardtype=null,roomno=null,roomtype=null,bed=null,dischargedate=null;
try {
con=databasecon.getconnection();
stmt = con.prepareStatement("select a.pid,a.pname,a.wardno,a.wardtype,a.roomno,a.roomtype,a.bed,b.dischargedate from patient a,discharge b where a.pid=b.pid and a.disstatus like 'Discharged';");
...
while (rs.next())  {
	      ...
	      pid=rs.getString("pid");
		   ...
		   dischargedate=rs.getString("dischargedate");
