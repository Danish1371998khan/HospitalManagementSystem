...
<% 
	...
	try{
		...
		String sql1="select max(eid) from employee";
...
function valid()
{
var a = document.f.ename.value;
var b = document.f.euname.value;
...
<div id="main_container">
    ...
    <div id="main_content">
	<form name="f" method="post" action="employee1.jsp" onSubmit="return valid();">
	<h2 align="center" style="font-family:verdana;font-size:15px;">Add New Employee</h2>
	<table align="center" width="900">
	<tr>
	<td valign="top">
	<table align="center" width="400" style="border:15px solid orange;">
	<tr>
	<td height="31" class="paragraping">Employee ID:</td>
	<td><input type="text" name="eid" value="<%=x%>" class="fielditem" ></td>
	</tr>
	<tr>
	<td height="36" class="paragraping">Employee Name:</td>
	<td><input type="text" name="ename" class="fielditem"></td>
	</tr>
	<tr>
	<td height="36" class="paragraping">User Name:</td>
	<td><input type="text" name="euname" class="fielditem"></td>
	</tr>
	<tr>
