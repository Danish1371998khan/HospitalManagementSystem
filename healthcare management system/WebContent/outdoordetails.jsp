      ...
      <div style="position:absolute; left:550px; top:60px;"><font color="#FF9900" size="5"><strong>Health Care Management System</strong></font> </div>
        ...
        <div id="menu">
            <ul>                                        
                ...
                <li><a href="outdoordetails.jsp" title="">View Outdoor Patients</a></li>
...
ResultSet rs = null;
String oid = null,pname = null,age = null,gender=null,fathername = null,city = null,dob = null,mobile=null,address=null,disease=null,admitteddate=null;
try {
con=databasecon.getconnection();
stmt = con.prepareStatement("select * from outpatient ");
	     
	   rs = stmt.executeQuery();
while (rs.next())  {

	      oid=rs.getString("pid");
