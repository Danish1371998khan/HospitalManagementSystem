...
while (rs.next())  {
	...
	/*<%
					...
					%> 
	<form name="f" method="post" action="dis1.jsp" onSubmit="return valid();">
	...
	<td><input  name="pid" value="<%out.println(rs.getString(1));%>"></td>
	</tr>
	<tr>
	<td height="36" class="paragraping">Patient Name:</td>
	<td><input name="pname" value="<%out.println(rs.getString(2));%>"></td>
	</tr>
	
	<tr>
	<td height="36" class="paragraping">Ward Number:</td>
	<td><input disabled="disabled" name="wardno" value="<%out.println(rs.getString(3));%>"></td>
	</tr>
	
	
	<tr>
	<td height="36" class="paragraping">Ward Type:</td>
	<td><input disabled="disabled" name="wardtype" value="<%out.println(rs.getString(4));%>"></td>
	</tr>
	<tr>
	<td height="36" class="paragraping">Room Number:</td>
	<td><input disabled="disabled" name="roomno" value="<%out.println(rs.getString(5));%>"></td>
	</tr>
	<tr>
	<td height="36" class="paragraping">Room Type:</td>
	<td><input  disabled="disabled" name="roomtype" value="<%out.println(rs.getString(6));%>"></td>
	</tr>
	<td height="36" class="paragraping">Discharge Date</td>
	<td><input type="text" name="dischargedate" class="fielditem"></td>
